...
const CustomDrawer = (props) => {
 ...
 <View style={{ flex:1,justifyContent:"flex-end", alignItems:"center"}}>
    ...
    <TouchableOpacity onPress={()=>handleDeleteAccount()} style={{ backgroundColor:"red", marginTop:50, padding:15,paddingLeft:45, paddingRight:45, marginLeft:15}}>
      <Text style={{color:"white", fontSize:14, fontWeight:"700"}}> Delete User</Text>
    </TouchableOpacity>
       </View>
